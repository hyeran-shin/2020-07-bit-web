		...
		<div id="content">
			<div id="user">
				<form id="join-form" name="joinform" method="post" action="">
					 <label class="block-label" for="usersName">이름</label>
					 <input type="text" id="usersName" name="usersName" value="${userVo.usersName}">
					  <spring:hasBindErrors name="userVo">
		                  <c:if test="${errors.hasFieldErrors('usersName')}">
		                     <p style="text-align:left; color:red">
		                        <spring:message code="${errors.getFieldError('usersName').codes[0]}" text="${errors.getFieldError('usersName').defaultMessage}"/>
		                     </p>
		                  </c:if>
					 ...
					 <input type="hidden" value="${userVo.usersNo}" name="usersNo">
